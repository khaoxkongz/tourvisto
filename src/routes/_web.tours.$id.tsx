...
export const Route = createFileRoute("/_web/tours/$id")({
...
function RouteComponent() {
  return (
    <div className="flex flex-col flex-1 bg-[#F9FBFC]">
      <ContainerWrapper>
        <Container className="flex flex-col gap-16 pt-40 pb-16">
          <section className="theme-container grid grid-cols-5 gap-16">
            <Link to="/" className={cn(buttonVariants({ variant: "outline" }), "w-fit mx-auto")}>
              Go Back
            </Link>
